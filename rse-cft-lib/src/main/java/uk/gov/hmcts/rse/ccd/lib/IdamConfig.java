...
//class IdamConfig {
//
//  @ForProjects({ComposeRunner.project.datastore, ComposeRunner.project.definitionstore})
//  @Bean
...
//  @ForProjects(ComposeRunner.project.application)
//  @Bean
//  public IdamClient defaultIdam(IdamApi idam, OAuth2Configuration oauth) {
//    return new IdamClient(idam, oauth);
//  }
//
//  @ForProjects(ComposeRunner.project.am)
//  @Bean
...
//  }
//
//  @ForProjects(ComposeRunner.project.datastore)
//  @Bean
...
//  }
//
//  @ForProjects(ComposeRunner.project.definitionstore)
//  @Bean
